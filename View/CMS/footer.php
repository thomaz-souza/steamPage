		...
		<!-- <script src="~public/cms/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.4"></script> -->

		<!--end::Page Vendors-->

		<!--begin::Page Scripts(used by this page)-->
		<!-- <script src="~public/cms/assets/js/pages/widgets.js?v=7.0.4"></script> -->
